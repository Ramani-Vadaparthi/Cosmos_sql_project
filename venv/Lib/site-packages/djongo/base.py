...
class CachedCollections(set):
    ...
    def __contains__(self, item):
        ...
        self.update([cont['id'] for cont in self.db.list_containers()])
        #end Ramani
...
class DatabaseWrapper(BaseDatabaseWrapper):
    ...
    def get_new_connection(self, connection_params):
        ...
        #start Ramani3
        # connection_params['document_class'] = OrderedDict    #comment
        #end Ramani3
        ...
        database = self.client_connection.get_database_client(name)
        #end Ramani
