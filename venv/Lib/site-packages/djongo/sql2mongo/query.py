...
#start Ramani
            ...
            self.db.create_container_if_not_exists('__schema__',partition_key=PartitionKey(path='/name'))
#end Ramani
        ...
        try:
            ...
            if table == 'django_migrations':
                self.db.create_container_if_not_exists(table,partition_key=PartitionKey(path='/app'))
            else:
                self.db.create_container_if_not_exists(table)
            #end Ramani
...
class Query:
    ...
    def __init__(self,
                 ...
                 client_connection: CosmosClient,
                 # db_connection: Database,
                 db_connection: DatabaseProxy,
                 #end Ramani
                 connection_properties: 'base.DjongoClient',
                 sql: str,
